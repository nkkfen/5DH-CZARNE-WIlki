 ...
 * - api.registerError()      -> zgłasza błąd (-20 pkt)
 * - api.completeGame()       -> kończy minigrę i przechodzi do następnej
...
function computeScore(errors, elapsedSeconds) {
  const raw =
    GAME_CONFIG.maxScore -
    errors * GAME_CONFIG.errorPenalty -
...
function finishCurrentGame() {
  ...
  const score = computeScore(state.errors, elapsed);
